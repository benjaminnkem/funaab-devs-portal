...
const DashboardHome = () => {
  ...
  // using this approach makes the file for shorter (- using .map() to iterate over them)
              ...
              <div className="mt-3 space-y-2">
                <div className="flex items-center space-x-4">
                  ...
                  <p>
                    ...
                    <span className="font-semibold text-green-500 border-b border-green-500 cursor-pointer">
                      Davicci
                    </span>
                  </p>
                </div>
